...
const ColorChooser: React.FC<ColorChooserProps> = ({ color, onChange }) => {
  ...
  const handleRgbChange = (idx: number, value: number) => {
    ...
    setRgb(
      (prev) =>
        prev.map((v, i) => (i === idx ? clamped : v)) as [
          number,
          number,
          number,
        ],
  ...
  return (
    <div className="dlasim-color-chooser">
      <div
        className="dlasim-color-chooser-preview"
      ...
      <div className="dlasim-color-chooser-fields">
        <div className="dlasim-color-chooser-row">
          ...
          <input
            ...
            max={255}
            value={rgb[0]}
            onChange={(e) => handleRgbChange(0, Number(e.target.value))}
          />
          <input
            type="number"
            min={0}
        ...
        <div className="dlasim-color-chooser-row">
          ...
          <input
            ...
            max={255}
            value={rgb[1]}
            onChange={(e) => handleRgbChange(1, Number(e.target.value))}
          />
          <input
            type="number"
            min={0}
        ...
        <div className="dlasim-color-chooser-row">
          ...
          <input
            ...
            max={255}
            value={rgb[2]}
            onChange={(e) => handleRgbChange(2, Number(e.target.value))}
          />
          <input
            type="number"
            min={0}
