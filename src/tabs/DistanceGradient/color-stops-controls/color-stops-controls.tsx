...
const ColorStopsControls: React.FC = () => {
  ...
  const activeColor =
    colorStops.find((stop) => stop.id === activeColorId)?.color || "";
          ...
          <div key={stop.id} className="color-stop-row">
            <div
              ...
              style={{
                ...
                border:
                  stop.id === activeColorId
                    ? "2px solid var(--dlasim-primary-color)"
                    : undefined,
              }}
